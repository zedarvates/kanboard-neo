...
class ColumnModelTest extends Base
{
    ...
    public function testGetAll()
    {
        ...
        $this->assertEquals('Started', $columns[2]['title']);

        $this->assertEquals(4, $columns[3]['id']);
        $this->assertEquals(4, $columns[3]['position']);
        $this->assertEquals('In Review', $columns[3]['title']);

        $this->assertEquals(5, $columns[4]['id']);
        $this->assertEquals(5, $columns[4]['position']);
        $this->assertEquals('Done', $columns[4]['title']);

        $this->assertEquals(6, $columns[5]['id']);
        $this->assertEquals(6, $columns[5]['position']);
        $this->assertEquals('Canceled', $columns[5]['title']);
    }
